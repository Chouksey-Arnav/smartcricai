...
export default function MatchHistory() {
  ...
  const { data: matches = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const results = await base44.entities.Match.filter({ user_email: guestEmail });
          ...
          <div className="space-y-3">
            {isLoading ? (
              ...
              <div className="text-center py-12">
                <Trophy className="w-16 h-16 text-slate-200 dark:text-slate-700 mx-auto mb-3" />
                <p className="text-slate-500 dark:text-slate-400">No matches logged yet</p>
              </div>
            ) : (
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <h3 className="font-bold text-slate-800 dark:text-white capitalize">{match.match_type} Match</h3>
                      </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-3">
                    {match.batting_stats?.runs !== undefined && (
                      <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-2">
                        <p className="text-xs text-blue-600 dark:text-blue-400 font-medium">Batting</p>
                    ...
                    {match.bowling_stats?.wickets !== undefined && (
                      <div className="bg-red-50 dark:bg-red-900/30 rounded-lg p-2">
                        <p className="text-xs text-red-600 dark:text-red-400 font-medium">Bowling</p>
