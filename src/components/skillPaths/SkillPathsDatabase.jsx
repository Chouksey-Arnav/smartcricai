...
export const skillPathsData = {
  batting: {
    ...
    color: 'blue',
    levels: {
      beginner:     buildLevel('bat', 'beginner',     BATTING, { name: 'Batting Beginner',     subtitle: 'Build your core batting foundation',      color: 'emerald', unlockXP: 0,    isPremium: false, badge: { name: 'Batting Starter',  lucideIcon: 'Target', rarity: 'common'    } }),
      intermediate: buildLevel('bat', 'intermediate', BATTING, { name: 'Batting Intermediate', subtitle: 'Develop power, timing and stroke play',     color: 'blue',    unlockXP: 2000, isPremium: false, badge: { name: 'Stroke Maker',     lucideIcon: 'Zap',    rarity: 'rare'      } }),
      advanced:     buildLevel('bat', 'advanced',     BATTING, { name: 'Batting Advanced',     subtitle: 'Elite technique and match intelligence',   color: 'purple',  unlockXP: 5000, isPremium: false, badge: { name: 'Elite Batter',     lucideIcon: 'Trophy', rarity: 'epic'      } }),
      pro:          buildLevel('bat', 'pro',           BATTING, { name: 'Batting Pro',           subtitle: 'Championship-level batting mastery',       color: 'amber',   unlockXP: 7500, isPremium: true,  badge: { name: 'Pro Batter',       lucideIcon: 'Crown',  rarity: 'legendary' } }),
    },
  },
  bowling: {
    name: 'Bowling Path',
    ...
    color: 'green',
    levels: {
      beginner:     buildLevel('bow', 'beginner',     BOWLING, { name: 'Bowling Beginner',     subtitle: 'Master action, line and length basics',    color: 'emerald', unlockXP: 0,    isPremium: false, badge: { name: 'Bowler Starter',   lucideIcon: 'Target', rarity: 'common'    } }),
      intermediate: buildLevel('bow', 'intermediate', BOWLING, { name: 'Bowling Intermediate', subtitle: 'Develop swing, seam and yorkers',          color: 'blue',    unlockXP: 2000, isPremium: false, badge: { name: 'Swing Master',     lucideIcon: 'Zap',    rarity: 'rare'      } }),
      advanced:     buildLevel('bow', 'advanced',     BOWLING, { name: 'Bowling Advanced',     subtitle: 'Elite pace, reverse swing and variations', color: 'purple',  unlockXP: 5000, isPremium: false, badge: { name: 'Elite Bowler',     lucideIcon: 'Trophy', rarity: 'epic'      } }),
      pro:          buildLevel('bow', 'pro',           BOWLING, { name: 'Bowling Pro',           subtitle: 'Championship-level bowling mastery',      color: 'amber',   unlockXP: 7500, isPremium: true,  badge: { name: 'Pro Bowler',       lucideIcon: 'Crown',  rarity: 'legendary' } }),
    },
  },
  wicket_keeping: {
    ...
    color: 'purple',
    levels: {
      beginner:     buildLevel('wk', 'beginner',     WICKET_KEEPING, { name: 'Keeping Beginner',     subtitle: 'Learn stance, glove work and catching',   color: 'emerald', unlockXP: 0,    isPremium: false, badge: { name: 'Keeper Starter',   lucideIcon: 'Target', rarity: 'common'    } }),
      intermediate: buildLevel('wk', 'intermediate', WICKET_KEEPING, { name: 'Keeping Intermediate', subtitle: 'Develop stumping, coordination & speed',  color: 'blue',    unlockXP: 2000, isPremium: false, badge: { name: 'Smart Keeper',     lucideIcon: 'Zap',    rarity: 'rare'      } }),
      advanced:     buildLevel('wk', 'advanced',     WICKET_KEEPING, { name: 'Keeping Advanced',     subtitle: 'Elite glove work and match leadership',   color: 'purple',  unlockXP: 5000, isPremium: false, badge: { name: 'Elite Keeper',     lucideIcon: 'Trophy', rarity: 'epic'      } }),
      pro:          buildLevel('wk', 'pro',           WICKET_KEEPING, { name: 'Keeping Pro',           subtitle: 'Championship-level keeping mastery',     color: 'amber',   unlockXP: 7500, isPremium: true,  badge: { name: 'Pro Keeper',       lucideIcon: 'Crown',  rarity: 'legendary' } }),
    },
  },
};
