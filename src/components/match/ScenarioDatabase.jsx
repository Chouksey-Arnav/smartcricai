...
},
{
  ...
  category: 'batting',
  difficulty: 'medium',
  situation: 'T20: Powerplay over, you are 22 off 12. Pace bowler returns. Field is up again.',
  question: 'How do you capitalize?',
  options: [
    { text: 'Look for boundaries over the infield while field is up', correct: true, explanation: 'Smart! Use the field restrictions. Score when opportunity is there!' },
    { text: 'Block everything to consolidate', correct: false, explanation: 'Waste of powerplay overs! Be positive!' },
    { text: 'Try reverse ramp every ball', correct: false, explanation: 'Too risky and predictable. Mix your shots!' },
    { text: 'Just defend till field goes back', correct: false, explanation: 'Field restrictions are your friend! Use them!' }
  ]
},
{
  id: 'new_008',
  category: 'bowling',
  difficulty: 'hard',
  situation: 'Test: Session 2, batsman is 150 not out. Tired. You are tired too. Hot day.',
  question: 'How do you get him out?',
  options: [
    { text: 'Test his concentration - tight lines, patience, wait for tired mistake', correct: true, explanation: 'Perfect! Fatigue is your ally. Make him work for every run!' },
    { text: 'Try bouncer barrage', correct: false, explanation: 'You are tired too! Be smart with energy!' },
    { text: 'Give up, he is too good', correct: false, explanation: 'Fatigue creates errors! Stay patient!' },
    { text: 'Bowl half-trackers to rest', correct: false, explanation: 'Easy runs! Bowl properly or ask for break!' }
  ]
},
{
  id: 'new_009',
  category: 'fielding',
  difficulty: 'medium',
  situation: 'Short leg position. Batsman sweeps, ball deflects off pad toward you at pace.',
  question: 'Reaction?',
  options: [
    { text: 'Hands ready, react on instinct, go for the catch', correct: true, explanation: 'Perfect! This is why you are there. Trust your reflexes!' },
    { text: 'Move away to avoid injury', correct: false, explanation: 'That is your job! Be brave!' },
    { text: 'Close your eyes', correct: false, explanation: 'Never! Watch the ball!' },
    { text: 'Appeal before catching', correct: false, explanation: 'Catch first! Then appeal!' }
  ]
},
{
  id: 'new_010',
  category: 'strategy',
  difficulty: 'medium',
  situation: 'ODI: You are defending 220. Low total. Opposition has strong batting.',
  question: 'Team strategy?',
  options: [
    { text: 'Attack from ball one, early wickets are crucial', correct: true, explanation: 'Perfect! Low total means must take risks to get wickets!' },
    { text: 'Defensive field, restrict to 220', correct: false, explanation: 'They will cruise easily! Must attack!' },
    { text: 'Give up, total too low', correct: false, explanation: 'Cricket is unpredictable! Fight!' },
    { text: 'Bowl only part-timers', correct: false, explanation: 'Use your best bowlers! This is crucial!' }
  ]
},
{
  id: 'new_011',
  category: 'pressure',
  difficulty: 'hard',
  situation: 'Finals. 2 runs needed off last ball. You are batting. Entire stadium on feet.',
  question: 'Shot selection mindset?',
  options: [
    { text: 'Watch the ball, play it on merit, find the gap', correct: true, explanation: 'Perfect! Simple plan. Trust your skills!' },
    { text: 'Wild slog without watching', correct: false, explanation: 'Need to connect! Watch it carefully!' },
    { text: 'Block it and panic', correct: false, explanation: 'Must try to score! 2 runs needed!' },
    { text: 'Run without hitting', correct: false, explanation: 'Still need to hit it! Focus and execute!' }
  ]
},
{
  id: 'new_012',
  category: 'mental',
  difficulty: 'medium',
  situation: 'You are not getting selected for matches. Others playing ahead of you.',
  question: 'Best response?',
  options: [
    { text: 'Work harder in training, ask coach for feedback, improve', correct: true, explanation: 'Champion response! Control what you can control!' },
    { text: 'Complain about unfair selection', correct: false, explanation: 'Earn your spot through performance!' },
    { text: 'Give up trying', correct: false, explanation: 'Persistence pays off! Keep fighting!' },
    { text: 'Be resentful of teammates', correct: false, explanation: 'Bad energy! Focus on yourself!' }
  ]
},
{
  id: 'new_013',
  category: 'batting',
  difficulty: 'easy',
  situation: 'Practice nets. You keep getting bowled. Getting frustrated.',
  question: 'How to improve?',
  options: [
    { text: 'Ask coach for technical help, watch the ball closer, practice more', correct: true, explanation: 'Perfect! Identify problem, get help, practice solution!' },
    { text: 'Give up and leave nets', correct: false, explanation: 'Practice is for mistakes! Stay and improve!' },
    { text: 'Blame the bowler', correct: false, explanation: 'It is your technique! Work on it!' },
    { text: 'Only face easy bowlers', correct: false, explanation: 'Challenge makes you better! Face tough bowling!' }
  ]
},
{
  id: 'new_014',
  category: 'bowling',
  difficulty: 'medium',
  situation: 'ODI: Batsman is 80 not out. You are spinner. He is sweeping you repeatedly.',
  question: 'Counter strategy?',
  options: [
    { text: 'Bowl quicker and flatter, take away his time to sweep', correct: true, explanation: 'Smart! Make his shot harder to execute!' },
    { text: 'Keep bowling same pace and flight', correct: false, explanation: 'He is comfortable! Change something!' },
    { text: 'Stop bowling spin completely', correct: false, explanation: 'That is your skill! Adjust execution!' },
    { text: 'Bowl full tosses', correct: false, explanation: 'Even easier to hit! Think smarter!' }
  ]
},
{
  id: 'new_015',
  category: 'captaincy',
  difficulty: 'hard',
  situation: 'Test: You are 50 ahead. 2 sessions left on Day 5. Rain forecast. Bat or declare?',
  question: 'Decision?',
  options: [
    { text: 'Bat 1 more session, set 200+, use final session + Day 6 if rain delays', correct: true, explanation: 'Smart! Build safe lead, account for rain, maximize win chances!' },
    { text: 'Declare now with 50 lead', correct: false, explanation: 'Too risky! 50 is chaseable!' },
    { text: 'Bat all day, play for draw', correct: false, explanation: 'Too defensive! Rain might help you bowl them out!' },
    { text: 'Forfeit innings', correct: false, explanation: 'Not strategic! Build proper lead!' }
  ]
},
{
  id: 'new_016',
  category: 'fielding',
  difficulty: 'easy',
  situation: 'Mid-off. Ball hit firmly at you on the bounce. Simple stop.',
  question: 'Technique?',
  options: [
    { text: 'Get body behind, watch into hands, secure stop', correct: true, explanation: 'Textbook! Simple execution wins matches!' },
    { text: 'Try one-handed pickup to look cool', correct: false, explanation: 'Risky! Could miss it. Keep it simple!' },
    { text: 'Let it go past', correct: false, explanation: 'Never! Stop every ball!' },
    { text: 'Kick it toward stumps', correct: false, explanation: 'Use your hands! More accurate!' }
  ]
},
{
  id: 'new_017',
  category: 'batting',
  difficulty: 'hard',
  situation: 'ODI: Chasing 310. You are 140 not out. 50 needed off 40 balls. Partner gets out.',
  question: 'New partnership approach with number 8?',
  options: [
    { text: 'Farm strike, protect tail, score in singles and bad balls', correct: true, explanation: 'Perfect! You are set. Use your form. Guide them home!' },
    { text: 'Let number 8 take equal responsibility', correct: false, explanation: 'He cannot handle this! It is your job!' },
    { text: 'Both defend for 30 balls', correct: false, explanation: 'Rate will balloon! Must keep scoring!' },
    { text: 'Try to hit everything for six', correct: false, explanation: 'Smart batting, not reckless! Singles work!' }
  ]
},
{
  id: 'new_018',
  category: 'pressure',
  difficulty: 'medium',
  situation: 'You are 12th man. Star bowler injured. Coach says you might bowl in a final.',
  question: 'Mental preparation?',
  options: [
    { text: 'Stay ready, warm up properly, visualize success, be prepared', correct: true, explanation: 'Perfect! Always ready! This could be your moment!' },
    { text: 'Panic about the responsibility', correct: false, explanation: 'Stay calm! You are trained for this!' },
    { text: 'Hope you do not have to bowl', correct: false, explanation: 'Wrong mindset! Embrace the opportunity!' },
    { text: 'Not warm up, assume you will not play', correct: false, explanation: 'Always be ready! Chance can come anytime!' }
  ]
},
{
  id: 'new_019',
  category: 'bowling',
  difficulty: 'easy',
  situation: 'Your first over in a match. Opening batsman on strike.',
  question: 'First ball plan?',
  options: [
    { text: 'Good length on off stump, settle into rhythm', correct: true, explanation: 'Perfect! Find your rhythm. Start with basics!' },
    { text: 'Bouncer first ball to intimidate', correct: false, explanation: 'Could go wrong! Settle first!' },
    { text: 'Try your best variation immediately', correct: false, explanation: 'Save it! Stock ball first!' },
    { text: 'Wide yorker', correct: false, explanation: 'Hard to execute when nervous! Keep it simple!' }
  ]
},
{
  id: 'new_020',
  category: 'strategy',
  difficulty: 'medium',
  situation: 'T20: Fielding. Score is 160-7 in over 18. Tail batting. How do you finish?',
  question: 'Field and bowling plan?',
  options: [
    { text: 'Attack the stumps, tight fields, finish the innings quickly', correct: true, explanation: 'Perfect! Every run matters. Get them out!' },
    { text: 'Spread field, let them score', correct: false, explanation: 'Why give free runs? Get wickets!' },
    { text: 'Bowl bouncers only', correct: false, explanation: 'Mix it up! Target stumps!' },
    { text: 'Give them easy singles', correct: false, explanation: 'Runs hurt you! Finish them!' }
  ]
},
{
  id: 'new_021',
  category: 'fielding',
  difficulty: 'hard',
  situation: 'You are keeping. Spinner bowling. Batsman dancing down. Ball beats him, coming to you.',
  question: 'Wicketkeeper action?',
  options: [
    { text: 'Collect cleanly, whip bails off quickly, stump him', correct: true, explanation: 'Perfect! This is your moment. Execute the stumping!' },
    { text: 'Drop it in panic', correct: false, explanation: 'Focus! You train for this!' },
    { text: 'Throw to bowler', correct: false, explanation: 'Too slow! Stump him yourself!' },
    { text: 'Appeal before collecting', correct: false, explanation: 'Collect first! Then appeal!' }
  ]
},
{
  id: 'new_022',
  category: 'mental',
  difficulty: 'hard',
  situation: 'Finals. You are captain. Star player injured during innings break. Must bowl now.',
  question: 'Team talk?',
  options: [
    { text: 'This is our chance. Someone steps up. We believe in each other.', correct: true, explanation: 'Leadership! Rally the team. Turn adversity into opportunity!' },
    { text: 'We cannot win now', correct: false, explanation: 'Defeats team before they start! Never!' },
    { text: 'Blame the injury', correct: false, explanation: 'Pointless! Focus on what you can control!' },
    { text: 'Panic visibly', correct: false, explanation: 'Captain sets the tone! Stay composed!' }
  ]
},
{
  id: 'new_023',
  category: 'batting',
  difficulty: 'medium',
  situation: 'T20: You need 60 off 36 balls. Set batsman. Bowlers trying slower balls.',
  question: 'Your approach?',
  options: [
    { text: 'Watch carefully, pick the slower balls, punish them', correct: true, explanation: 'Smart! Pick your moments. Slower balls are opportunities!' },
    { text: 'Swing blindly at everything', correct: false, explanation: 'Will miss the slower balls! Watch carefully!' },
    { text: 'Only block slower balls', correct: false, explanation: 'Need to score! Punish them when identified!' },
    { text: 'Try to hit full pace balls only', correct: false, explanation: 'Limited opportunities! Learn to hit slower balls!' }
  ]
},
{
  id: 'new_024',
  category: 'bowling',
  difficulty: 'medium',
  situation: 'ODI: Batsman is 110 not out. Big hundred. Fresh bowler coming on. You.',
  question: 'Fresh bowler strategy?',
  options: [
    { text: 'Challenge him with different angle and pace - surprise factor', correct: true, explanation: 'Good! He is set but you are fresh. Different look can work!' },
    { text: 'Bowl same as previous bowlers', correct: false, explanation: 'He played them well! Be different!' },
    { text: 'Bowl full tosses for him to reach 150', correct: false, explanation: 'What? No! Get him out!' },
    { text: 'Not even try', correct: false, explanation: 'Fresh bowler can break partnerships! Believe!' }
  ]
},
{
  id: 'new_025',
  category: 'captaincy',
  difficulty: 'medium',
  situation: 'T20: Chasing 180. After 12 overs, you are 100-2. Required rate is fine. Set batsmen.',
  question: 'Message from dressing room?',
  options: [
    { text: 'Keep going same way, do not force it, wickets in hand', correct: true, explanation: 'Perfect! Chasing well. No need to panic. Continue!' },
    { text: 'Accelerate hard now', correct: false, explanation: 'Unnecessary! Losing wickets is bigger risk!' },
    { text: 'Defend next 5 overs', correct: false, explanation: 'No need! Continue balanced approach!' },
    { text: 'Send pinch hitter', correct: false, explanation: 'Set batsmen are doing fine! Don\'t disrupt!' }
  ]
},
{
  id: 'new_026',
  category: 'fielding',
  difficulty: 'easy',
  situation: 'Ball hit to you at cover. Easy pickup. Batsmen not running.',
  question: 'What do you do?',
  options: [
    { text: 'Pick up cleanly, return to bowler, stay alert', correct: true, explanation: 'Good! Simple execution. Stay ready for next ball!' },
    { text: 'Throw at stumps anyway', correct: false, explanation: 'Could be overthrows! They are not running!' },
    { text: 'Hold onto ball', correct: false, explanation: 'Return it! Game must continue!' },
    { text: 'Celebrate the stop', correct: false, explanation: 'It was basic! Stay focused!' }
  ]
},
{
  id: 'new_027',
  category: 'batting',
  difficulty: 'hard',
  situation: 'Test: Day 5 final hour. Need 45 to win with 3 wickets. Pitch cracking up.',
  question: 'Batting strategy?',
  options: [
    { text: 'Defend good balls, score off bad balls, smart cricket to the finish', correct: true, explanation: 'Perfect! Test match batting. Respect good balls, win is close!' },
    { text: 'Block everything, hope for draw', correct: false, explanation: 'Win is there! 45 is gettable! Go for it!' },
    { text: 'Slog everything now', correct: false, explanation: 'Pitch is difficult! Smart batting needed!' },
    { text: 'Give up, pitch too hard', correct: false, explanation: 'Never! 45 runs away from victory!' }
  ]
},
{
  id: 'new_028',
  category: 'pressure',
  difficulty: 'medium',
  situation: 'Semifinals. You have not performed all tournament. One last chance to contribute.',
  question: 'Mindset?',
  options: [
    { text: 'Fresh start. This match is new. I can do this.', correct: true, explanation: 'Perfect! Past is gone. Focus on now!' },
    { text: 'Dwell on previous failures', correct: false, explanation: 'Past hurts confidence! Think positive!' },
    { text: 'Expect to fail again', correct: false, explanation: 'Self-fulfilling! Believe in yourself!' },
    { text: 'Ask to be dropped', correct: false, explanation: 'Cowardly! Seize your chance!' }
  ]
},
{
  id: 'new_029',
  category: 'bowling',
  difficulty: 'hard',
  situation: 'T20 finals: Last over, defending 9. Best hitter on strike. Free hit available.',
  question: 'Free hit ball strategy?',
  options: [
    { text: 'Wide yorker, minimize damage even if hit', correct: true, explanation: 'Smart! Cannot get out. Limit boundaries!' },
    { text: 'Perfect yorker on stumps', correct: false, explanation: 'Cannot get bowled! He will swing freely!' },
    { text: 'Bouncer', correct: false, explanation: 'Could be wide! Go wide yorker!' },
    { text: 'Give up', correct: false, explanation: 'Still defending 9! Very possible!' }
  ]
},
{
  id: 'new_030',
  category: 'strategy',
  difficulty: 'easy',
  situation: 'School match: Rain stopped play. Covers on. Break for 30 minutes.',
  question: 'What should team do during break?',
  options: [
    { text: 'Stay warm, discuss strategy, stay mentally ready', correct: true, explanation: 'Perfect! Use break productively. Stay sharp!' },
    { text: 'Relax completely', correct: false, explanation: 'Could lose focus! Stay engaged!' },
    { text: 'Assume match is over', correct: false, explanation: 'Could restart! Stay ready!' },
    { text: 'Leave the ground', correct: false, explanation: 'Must be ready to restart! Stay present!' }
  ]
},
{
  id: 'new_031',
  category: 'batting',
  difficulty: 'medium',
  situation: 'ODI: You are 95 not out. On course for maiden century. Leg spinner bowling.',
  question: 'Mental approach to next 5 runs?',
  options: [
    { text: 'Play each ball normally, century will come naturally', correct: true, explanation: 'Elite mindset! Process over milestone. Trust your game!' },
    { text: 'Take risky single to get to 99', correct: false, explanation: 'No need! Let it flow naturally!' },
    { text: 'Get nervous and freeze', correct: false, explanation: 'Keep playing your game! Stay natural!' },
    { text: 'Hit next ball for six to reach it', correct: false, explanation: 'Unnecessary risk! Patience got you to 95!' }
  ]
}
